        ...
        <div className="Main">
          ...
          >
            ...
            <div>
              <ReactTypingEffect
                text={[
                  "Welcome to the Bit Ghost Graveyard",
                  "Choose the NFT(s) you like!",
                  'Click "Mint" to claim 💎 NFT',
          ...
          <footer>
            {this.props.contract ? (
              <div style={{ color: "#8B8B8B", fontSize: "14px" }}>
                ...
                <a
                  href={
                    `https://${this.props.network}.fantomscan.com/address/` +
...
function mapStateToProps(state) {
  const dataLoaded =
    metadataLoadedSelector(state) && nftStateLoadedSelector(state);
  return {
